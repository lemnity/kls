...
- [ ] Реализовать (после discovery-подтверждения) цветовую индикацию узла по разнице плановой и согласованной суммы; до подтверждения — нейтральный индикатор, без изобретённых порогов. Не начато (discovery-gated).
