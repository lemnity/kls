...
- [ ] Написать E2E: продюсер утверждает позицию → создаёт задачу → начальник цеха назначает исполнителя → исполнитель принимает/закрывает → перенос без причины получает validation error.
