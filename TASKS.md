...
2. [x] На чистой PostgreSQL применить `npm run migrate:deploy --workspace @europa/db` и проверить `migrate:status`.
...
6. [x] Создать синтетический demo tenant «Театр Европа» через idempotent seed.
